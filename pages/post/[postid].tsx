...
function PostPage() {
  ...
  return (
    <div className="mx-auto my-7 max-w-5xl">
      ...
      <div className="-mt-1 rounded-b-md border border-t-0 border-gray-300 bg-white p-5 pl-16">
        ...
        >
          ...
          <button
            disabled={!session}
            type="submit"
            className="rounded-full bg-red-500 p-3 font-semibold text-white disable:bg-gray-200"
          >
            Comment
          </button>
        </form>
      ...
      <div className="-my-5 round-b-md border border-t-9 border-gray-300 bg-white py-5 px-10">
        <hr className="py-2" />
